class GetFavouritePropertyModel {
  int? status;
  String? message;
  List<FavouriteProperty>? data;

  GetFavouritePropertyModel({this.status, this.message, this.data});

  GetFavouritePropertyModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      data = <FavouriteProperty>[];
      json['data'].forEach((v) {
        data!.add(new FavouriteProperty.fromJson(v));
      });
    }
  }
