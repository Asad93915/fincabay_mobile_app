...
class PropertySearchScreen extends StatefulWidget {
  ...
  final int areaId;
  final int phaseId;
  const PropertySearchScreen({Key? key, required this.cityId, required this.areaId, required this.phaseId}) : super(key: key);
...
class _PropertySearchScreenState extends State<PropertySearchScreen> {
  _getSearch()async{
    ...
    await PropertySearchService().getSearch(context: context,cityId: widget.cityId, areaId: widget.areaId, phaseId: widget.phaseId);
          ...
          Row(
            ...
            children: [
              Hero(tag: 'propertyUrl',
                child:  Image.asset(
                 propSearch.uploadImage==null?imageUrl:propSearch.uploadImage!,
